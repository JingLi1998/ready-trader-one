...
class AutoTrader(BaseAutoTrader):
    ...
    def on_order_book_update_message(
        ...
        if instrument == Instrument.FUTURE:
            ...
            new_ask_price = (
                ask_prices[0] - self.position * 100 if ask_prices[0] != 0 else 0
            )
            ...
            if self.bid_id == 0 and new_bid_price != 0 and self.position < 100:
                ...
                self.send_insert_order(
                    self.bid_id, Side.BUY, new_bid_price, 1, Lifespan.GOOD_FOR_DAY
                )
            ...
            if self.ask_id == 0 and new_ask_price != 0 and self.position > -100:
                ...
                self.send_insert_order(
                    self.ask_id, Side.SELL, new_ask_price, 1, Lifespan.GOOD_FOR_DAY
                )
